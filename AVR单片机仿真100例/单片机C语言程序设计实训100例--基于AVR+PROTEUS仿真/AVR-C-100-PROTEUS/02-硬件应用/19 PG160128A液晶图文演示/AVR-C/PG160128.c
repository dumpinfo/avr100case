...
//取本例汉字12x12点阵库时,先在Zimo软件中设置字体字号为宋体小五号,
//取点阵前先设置横向取模,字节不倒序,然后输入汉字并按下Ctrl+Enter,
//最后按下取模按钮获取字模.
const struct typFNT_GB16 GB_16[] = { 
{{"统"},{0x21,0x00,0x27,0xE0,0x51,0x00,0xF2,0x00,0x24,0x40,0x47,0xE0,
         0xF2,0x80,0x02,0x80,0x32,0xA0,0xC4,0xA0,0x18,0xE0,0x00,0x00}},
{{"计"},{0x41,0x00,0x21,0x00,0x01,0x00,0x01,0x00,0xCF,0xE0,0x41,0x00,
         0x41,0x00,0x41,0x00,0x51,0x00,0x61,0x00,0x41,0x00,0x00,0x00}},
{{"图"},{0x7F,0xE0,0x48,0x20,0x5F,0x20,0x6A,0x20,0x44,0x20,0x4A,0x20,
...
INT8U LCD_Write_Command(INT8U cmd);                             //写无参数指令
