...
//使用时要用pgm_read_byte(uchar*)函数读取,该函数在avr/pgmspace.h中申明
//本例使用的图像点阵也存放于Flash中.
...
void cls();	                                     //清屏
char LCD_PINitialise();                          //LCD初始化
void Set_LCD_POS(INT8U row, INT8U col);          //设置当前地址
void charout(INT8U *str);                        //ASCII(8*8)显示函数
INT8U dprintf(INT8U x,INT8U y,char *fmt);        //ASCII(8*16)和汉字(16*16)显示函数
